...
export default function Contact() {
  ...
  return (
    <main
      ref={containerRef}
      id="contact"
      className="min-h-screen flex items-center justify-between px-20 py-20"
    >
      {/* MAP */}
      <div ref={mapRef}>
        <iframe
      ...
      <form
        ref={formRef}
        className="flex flex-col mx-auto max-w-3xl h-fit gap-5 border-x-2 rounded-full px-28 py-20 shadow-2xl shadow-white/20"
      >
